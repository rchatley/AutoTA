...
class IdentifierRule(SimpleRule):
    def __init__(self, scope='project', node_class='node', node_name='.*', node_annotations=None):
    ...
    def build_traversal(self):
        def traversal(ast):
            return get_instances_of(ast, node_class=self.node_class, node_name=self.node_name,
